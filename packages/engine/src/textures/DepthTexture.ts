...
import { NearestFilter, UnsignedIntType, DepthFormat, DepthStencilFormat, ClampToEdgeWrapping } from '../constants.js';
...
export class DepthTexture extends Texture {
  ...
  public copy(source: DepthTexture): this {
