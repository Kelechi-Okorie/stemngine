import { ClampToEdgeWrapping, Mipmap, RGBAFormat, TextureDataType, TextureFormat, UnsignedByteType } from '../constants.js';
...
export class CompressedArrayTexture extends CompressedTexture {
   ...
   * @default true
   */
  public readonly isCompressedArrayTexture: boolean = true;
   ...
   */
  public addLayerUpdate(layerIndex: number) {
