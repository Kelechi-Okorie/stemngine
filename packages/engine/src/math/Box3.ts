 ...
 */
   ...
   * @return {Box3} A reference to this bounding box.
   */
  public setFromObject(object: Node3D, precise: boolean = false): this {
   ...
   */
  public getBoundingSphere(target: Sphere): Sphere {
   ...
   */
  public toJSON(): { min: number[]; max: number[] } {
   ...
   * @return {Box3} A reference to this bounding box.
   */
  public fromJSON(json: { min: number[]; max: number[] }): Box3 {
