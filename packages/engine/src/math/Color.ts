...
type ColorName = keyof typeof _colorKeywords;
 ...
 * ```
 * If ColorManagement is disabled, no conversions occur. For details,
 ...
 */
   ...
   *
   * Note that standard method of specifying color in js is with a hexadecimal triplet,
   ...
   * @return {Color} A reference to this color.
   */
  public setStyle(style: string, colorSpace: string = SRGBColorSpace): Color {

    function handleAlpha(string: string | undefined) {
   ...
   * @return {Color} A reference to this color.
   */
  public setColorName(style: string, colorSpace: string = SRGBColorSpace): Color {

    // color keywords
    const hex = _colorKeywords[style.toLowerCase() as keyof typeof _colorKeywords];
   ...
   */
  public getHexString(colorSpace: string = SRGBColorSpace): string {
   ...
   * @return {Color} A reference to this color.
   */
  public lerpColors(color1: Color, color2: Color, alpha: number): Color {
   ...
   * @return {Color} A reference to this color.
   */
  public lerpHSL(color: Color, alpha: number): Color {
