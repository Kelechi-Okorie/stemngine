 ...
 */
   ...
   */
  public static getInterpolation(
    point: Vector3,
    p1: Vector3,
    p2: Vector3,
    p3: Vector3,
  ...
  public static getInterpolatedAttribute(
    ...
    target.setScalar(0);
    target.addScaledVector(_v40 as unknown as Vector3, barycoord.x);
    target.addScaledVector(_v41 as unknown as Vector3, barycoord.y);
    target.addScaledVector(_v42 as unknown as Vector3, barycoord.z);
   ...
   */
  public getPlane(target: Plane): Plane {
   ...
   * @return {?Vector3} The barycentric coordinates for the given point
   */
  public getBarycoord(point: Vector3, target: Vector3): Vector3 | null {
