 ...
 * @returns The half precision floating point value.
 */
 ...
 *
 * @param val - The half precision floating point value.
 * @returns The single precision floating point, FP32 value.
 */
