...
function getTextureTypeByteLength(type: TextureDataType) {
...
export class TextureUtils {
   ...
   * @return {Texture} The updated texture.
   */
  public static contain(texture: Texture, aspect: number): Texture {
   ...
   * @return {Texture} The updated texture.
   */
  public static cover(texture: Texture, aspect: number): Texture {
   ...
   * @return {Texture} The updated texture.
   */
  public static fill(texture: Texture): Texture {
