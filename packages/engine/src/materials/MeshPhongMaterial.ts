import { EnvironmentColorOperation, LineCap, MultiplyOperation, TangentSpaceNormalMap } from '../constants.js';
...
export class MeshPhongMaterial extends Material {
   ...
   * @type {Color}
   */
  public specular: Color = new Color(0x111111);
   ...
   * @default (0,0,0)
   */
  public emissive: Color = new Color(0x000000);
   ...
   */
  public normalMapType: EnvironmentColorOperation = TangentSpaceNormalMap;
   ...
   * @default 'round'
   */
  public wireframeLinejoin: LineCap = 'round';
