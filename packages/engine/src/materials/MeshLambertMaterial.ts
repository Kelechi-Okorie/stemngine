import { EnvironmentColorOperation, LineJoin, LineCap, MultiplyOperation, NormalMapType, TangentSpaceNormalMap } from '../constants.js';
...
export class MeshLambertMaterial extends Material {
  ...
  public type: string = 'MeshLambertMaterial';
