import { BackSide, LinearFilter, LinearMipmapLinearFilter, NoBlending } from '../constants';
...
export class WebGLCubeRenderTarget extends WebGLRenderTarget {
   ...
   * @default true
   */
  public isWebGLCubeRenderTarget: boolean = true;
   ...
   */
  constructor(size: number = 1, options: Record<string, any> = {}) {
   ...
   */
  public clear(renderer: WebGLRenderer, color = true, depth = true, stencil = true): void {
