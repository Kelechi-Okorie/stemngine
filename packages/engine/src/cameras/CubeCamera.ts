 ...
 * const cubeRenderTarget = new WebGLCubeRenderTarget( 256, { generateMipmaps: true, minFilter: LinearMipmapLinearFilter } );
 *
 * // Create cube camera
 ...
 * @augments Object3D
 */
export class CubeCamera extends Node3D {
  public type: string = 'CubeCamera';
  ...
  /**
    ...
    * @default null
    */
  public coordinateSystem: CoordinateSystem | null = null;
  ...
  updateCoordinateSystem() {
    ...
    if (coordinateSystem === WebGLCoordinateSystem) {
      ...
      throw new Error('CubeCamera.updateCoordinateSystem(): Invalid coordinate system: ' + coordinateSystem);
