...
class EffectComposer {
    ...
    constructor(renderer: WebGLRenderer, renderTarget?: WebGLRenderTarget) {
        ...
        this.renderTarget2 = renderTarget.clone() as WebGLRenderTarget;
        ...
        for (let i = 0, il = this.passes.length; i < il; i++) {
            ...
            if (pass.needsSwap) {
                ...
                if (maskActive) {
                    ...
                    this.copyPass.render(this.renderer, this.writeBuffer, this.readBuffer, deltaTime, true);
    ...
    public reset(renderTarget: WebGLRenderTarget): void {
        ...
        if (renderTarget === undefined) {
            ...
            renderTarget = this.renderTarget1.clone() as WebGLRenderTarget;
